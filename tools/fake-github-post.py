...
payload = {
    ...
    'commits': [{
        'added': [],
        'author': {'email': 'rbean@redhat.com', 'name': 'Ralph Bean',
                   'username': 'ralphbean'},
        'committer': {'email': 'rbean@redhat.com', 'name': 'Ralph Bean'
                      , 'username': 'ralphbean'},
        'distinct': True,
        'id': '81eacd09c4d6526bea1d14e3fbc17ef0fd1d9192',
        'message': 'Authentication policy.',
        'modified': ['statatat/__init__.py', 'statatat/views.py'],
        'removed': [],
    ...
    'head_commit': {
        ...
        'committer': {'email': 'rbean@redhat.com',
                      'name': 'Ralph Bean', 'username': 'ralphbean'},
        'distinct': True,
        'id': '3ef21292dd6448d4731f49864844d458ad3801a5',
        'message': 'Keep "identity" in the globals like TG2.',
        'modified': ['statatat/views.py'],
    ...
    'repository': {
        'created_at': '2012-07-05T21:22:12-07:00',
...
import requests
requests.post('http://localhost:6543/webhook', data=blob)
